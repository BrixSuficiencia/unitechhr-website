    ...
    <div className={`container ${isNavOpen ? 'sidebar-open' : ''}`}>
        ...
        <div className="notification-container">
          ...
          {isDropdownOpen && (
            <div className="notification-dropdown">
              ...
              <Link to="/Developer/Notifications" className="view-all-link">
      ...
      <nav className={`sidebar ${isNavOpen ? 'open' : ''}`}>
        <ul>
          ...
          <li><Link to="/Developer/Notifications">Notifications</Link></li>
          <li><Link to="/Developer/Universities">Universities</Link></li>
        </ul>
      </nav>
